...
module.exports.stylus = (function () {
  ...
  try {
    ...
    // Acts as middleware and alerts user to install stylus
    return function () {
      throw e;
    };
  }
...
module.exports.coffee = (function () {
  ...
  try {
    ...
    // Acts as middleware and alerts user to install Snockets
    return function () {
      throw e;
    };
  }
  ...
  return function (root, options, cache, maxage) {
    // Return transformation middleware
    return middleware({
      root: root,
      match: /(.+)\.js/,
      ...
      transform: function (path, send) {
        snockets.getConcatenation(path, options, function (err, js) {
