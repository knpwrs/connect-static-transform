...
Optionally, the following keys may be specified:
  ...
  maxage: Sets the maximum number of seconds a client and server should cache the output for. Defaults to one year. When cache expires, transforation runs again.
