...
module.exports = function (options) {
  ...
  return function (req, res, next) {
    ...
    if (options.cache && cache[path]) {
      ...
      writeOut(res, cacheVal.out, cacheVal.headers, options);
    } else {
...
// Write output
function writeOut(res, out, headers, options) {
